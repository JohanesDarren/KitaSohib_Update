...
function setupDatabase() {
  const schemas = {
    ...
    'schools': ['id', 'school_name', 'address', 'contact_email', 'phone', 'subscription_plan', 'subscription_end_date', 'subscription_expires_at', 'school_logo', 'school_color_hex', 'created_at'],
